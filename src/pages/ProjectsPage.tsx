...
export const ProjectsPage: React.FC = () => {
  return (
    <div className="min-h-screen">
      {/* Page Header */}
      <div className="bg-gradient-to-r from-purple-50 to-blue-50 dark:from-purple-900/20 dark:to-blue-900/20 py-12">
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xl text-gray-600 dark:text-gray-300">
                Innovative solutions with real-world impact and measurable results
              </p>
            </div>
